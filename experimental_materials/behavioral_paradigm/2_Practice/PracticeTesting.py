...
expName = 'PracticeTesting'  # from the Builder filename that created this script
...
trials = data.TrialHandler(nReps=1, method='random', 
    ...
    trialList=data.importConditions(u'xlsx\\Practice_Testing_S'+str(expInfo['session'])+'_P'+str(expInfo['participant'])+'.xlsx'),
